...
namespace Aplicacion.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUsuarios,Nombre,Apellido,Rut,Edad")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuarios,Nombre,Apellido,Rut,Edad")] Usuario usuario)
        {
